...
def launch_setup(context):
    ...
    if compiled == 'True':
        ...
        controller_package_path = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))), 'driver', 'controller')
        peripherals_package_path = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))), 'peripherals')
