...
#define ivErr_ResultError ((ivStatus)25)              /*解码器Wfst输出后，依然有cmd输出*/
#define ivErr_ShortPause ((ivStatus)26)
#define ivErr_Busy		   ((ivStatus)27)
#define ivErr_GrmNotUpdate ((ivStatus)28)
#define ivErr_Started ((ivStatus)29)
#define ivErr_Stopped ((ivStatus)30)
#define ivErr_AlreadyStarted ((ivStatus)31)
#define ivErr_AlreadyStopped ((ivStatus)32)
#define ivErr_TooManyCmd     ((ivStatus)33)
#define ivErr_Wait     ((ivStatus)34)//程序可能在做一些操作，主线程需要等待
#define ivErr_MAERight ((ivStatus)35)
#define ivErr_MAEWrong ((ivStatus)36)
...
#define ivErr_GrmRefTooComplex                              0x1038
#define ivErr_GrmRuleDefinitionPredefRule					0x1039

#define	ivErr_GetDictError                                  0x1040
#define	ivErr_GrmDictNumLimited                             0x1041
#define	ivErr_GrmWNetNumLimited                             0x1042
#define	ivErr_GrmCommitting                                 0x1043
