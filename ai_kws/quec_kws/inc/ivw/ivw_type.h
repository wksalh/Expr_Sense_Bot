...
public:
	...
	virtual ivInt wIvwResourceAdd(const IVW_RES_SET& resSet, const ivChar* pRes, IVW_RES_LOCATION eResLocation, ivUInt nResSize = 0, const IVW_RES_SET* pDependentRes = NULL, ivUInt resCount = 0, ivUInt noffset = 0) = 0;
