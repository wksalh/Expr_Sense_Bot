...
class JoystickController(Node):
    def __init__(self, name):
        ...
        self.declare_parameter('max_angular', 9.0)
        ...
        self.servo_state_pub = self.create_publisher(MotorsSpeedControl, '/ros_robot_controller/set_motor_speeds', 10)  # Define servo_state_pub
